...
//			System.out.println (differ.getDiff ());
			simpleCheckAnnotations (differ, 0, 0, 1, 0, false, false, false, true, true, false);
		}
		catch (Exception e)
		{
			e.printStackTrace();
...
//			System.out.println (differ.getDiff ());
			simpleCheckAnnotations (differ, 2, 2, 0, 0, false, false, true, false, false, false);
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	private void simpleCheckAnnotations (
		...
		boolean changeSpec, boolean changeModelName, boolean changeEntityIdentifier) throws XmlDocumentParseException, IOException, JDOMException
	{
...
//			System.out.println (differ.getDiff ());
			simpleCheckAnnotations (differ, 0, 5, 0, 0, true, true, true, false, false, true);
...
//			System.out.println (differ.getDiff ());
			simpleCheckAnnotations (differ, 0, 0, 1, 0, true, false, true, false, false, false);
...
//			System.out.println (differ.getDiff ());
			simpleCheckAnnotations (differ, 0, 0, 1, 0, false, false, false, false, false, true);
...
//			System.out.println (differ.getDiff ());
	...
	public void  testModelsEqual ()
	{
		try
		{
			...
			simpleCheckAnnotations (differ, 0, 0, 0, 0, false, false, false, false, false, false);
