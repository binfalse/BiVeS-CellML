...
This module implements special stategies for computational models encoded in [CellML format](https://www.cellml.org/).
**More documentation on the BiVeS-CellML** can be found and the [GitHub pages of the SEMS project](https://semsproject.github.io/BiVeS-CellML/).
